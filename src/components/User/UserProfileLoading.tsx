/**
 * matches the real profile geometry — 88px avatar, the name, the @login/#id
 * handle line, bio and facts, three controls — so nothing moves when the data
 * lands. the tabs are not in here on purpose: they are already known before the
 * fetch, so UserProfile keeps drawing the real ones around this.
 */
