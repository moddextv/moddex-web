    ...
    <>
      ...
      <div className="mt-2 mb-8">
        <p>By accessing this Website, accessible from https://modchecker.com/, you are agreeing to be bound by these
          ...
          laws.
          If you disagree with any of these terms, you are prohibited from accessing this site. The materials contained
          in
      ...
      <div className="mt-2 mb-8">
        <p>Permission is granted to temporarily download one copy of the materials on modchecker's Website for personal,
        ...
        <p>
          This will let modchecker to terminate upon violations of any of these restrictions. Upon termination, your
          viewing
      ...
      <div className="mt-2 mb-8">
        <p>All the materials on modchecker's Website are provided "as is". Modchecker makes no warranties, may it be
          expressed
          or implied, therefore negates all other warranties. Furthermore, modchecker does not make any representations
      ...
      <div className="mt-2 mb-8">
        <p>Modchecker or its suppliers will not be hold accountable for any damages that will arise with the use or
          inability
          to use the materials on modchecker's Website, even if modchecker or an authorize representative of this
          Website
          has
      ...
      <div className="mt-2 mb-8">
        <p>The materials appearing on modchecker's Website may include technical, typographical, or photographic errors.
          Modchecker will not promise that any of the materials in this Website are accurate, complete, or current.
          Modchecker may change the materials contained on its Website at any time without notice. Modchecker does not
          make any
      ...
      <div className="mt-2 mb-8">
        <p>Any claim related to modchecker's Website shall be governed by the laws of us without regards to its conflict
          of law
          provisions.
        </p>
      </div>
