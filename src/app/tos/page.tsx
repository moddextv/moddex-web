      ...
      <Container>
        <header className="enter pt-12 pb-8">
          ...
          <p className="text-ui text-primary-400">
            Last updated {new Date().getFullYear()}. {name} is not affiliated with, endorsed by, or
            sponsored by Twitch Interactive, Inc.
          </p>
        </header>

        {/* the thing most readers came for, ahead of the contract */}
        <section className="enter pb-10 max-w-3xl" style={{ '--i': 1 } as CSSProperties}>
          <div className="panel">
            ...
            <p className="text-read text-primary-300 max-w-prose mb-6">
              Sign in with twitch and enable the opt-out. Your profile stops being served, and you
              are removed from every mod and vip list and from the public api. It is one switch, and
        ...
        <div className="enter flex gap-12 pb-4" style={{ '--i': 2 } as CSSProperties}>
          <div className="min-w-0 flex-1 max-w-3xl flex flex-col gap-10">
            <Clause id="acceptance" title="1. Acceptance">
              <Para>
                ...
                you agree to these terms. If you disagree with any part of them, please do not use
                the site.
              </Para>
            </Clause>
            ...
            <Clause id="service" title="2. What this service does">
              <Para>
                {name} records which Twitch accounts hold moderator or VIP status in which Twitch
                channels, and when that status was granted. This information is retrieved from
                Twitch&apos;s own interfaces and is visible to anyone who can view the channel in
                question.
              </Para>
              <Para>
                A channel is only indexed once somebody looks it up. We do not read chat messages,
                private messages, email addresses, or anything that is not publicly visible on
                Twitch.
              </Para>
            </Clause>
            ...
            <Clause id="your-data" title="3. Your data and how to opt out">
              <Para>
                If you are listed on {name}, we hold the fields below plus the mod and VIP roles
                described above.
              </Para>
              ...
              <Para>
                <strong className="text-primary-100">You can opt out at any time.</strong> Sign in
                with Twitch and enable the opt-out in{' '}
                <Inline href="/settings">your settings</Inline>. Your profile then stops being
                served and you are removed from every mod and VIP list and from the public API. The
                opt-out is reversible: switching it back off restores your entry.
              </Para>
              <Para>
                Accounts that Twitch reports as banned or deactivated are marked as such and are not
                displayed.
              </Para>
            </Clause>
            ...
            <Clause id="accounts" title="4. Accounts and donations">
              <Para>
                Signing in uses Twitch OAuth; we never see your Twitch password. Donations are
                processed by Stripe, and card details are handled entirely by Stripe. We store only
                the payment reference, the amount, and the name and email Stripe returns to us.
              </Para>
              <Para>
                Donations are voluntary contributions towards running costs, not purchases. Cosmetic
                badges granted alongside a donation carry no monetary value and may change or be
                withdrawn. Donations are generally non-refundable; if something went wrong, contact
            ...
            <Clause id="use" title="5. Acceptable use">
              <Para>
                Do not use {name} to harass, dox, or target anyone, and do not attempt to disrupt
                the service or scrape it in a way that degrades it for others. The public API is
            ...
            <Clause id="disclaimer" title="6. Disclaimer and liability">
              <Para>
                {name} is provided &quot;as is&quot;, without warranty of any kind. The data is
                gathered automatically and may be incomplete, stale, or wrong. It should not be
                relied upon for any decision that matters.
              </Para>
              <Para>
                To the extent permitted by law, we are not liable for any damages arising from the
                use of, or inability to use, this site. Some jurisdictions do not allow such
                limitations, in which case they may not apply to you.
              </Para>
            </Clause>

            <Clause id="changes" title="7. Changes">
              <Para>
                We may revise these terms at any time. Continuing to use the site means you accept
                the current version.
              </Para>
            </Clause>
